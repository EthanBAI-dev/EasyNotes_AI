...
const zh = {
  ...
  'youtube.downloadToNlm': '下载到 NotebookLM ({count})',
  ...
  'youtube.cancel': '取消',
  'onboarding.stepYouTube': '粘贴 YouTube 视频、播放列表或频道链接，批量下载字幕到 NotebookLM。',
...
const en: Record<keyof typeof zh, string> = {
  ...
  'youtube.downloadToNlm': 'Download to NotebookLM ({count})',
  ...
  'onboarding.stepYouTube': 'Paste YouTube video, playlist, or channel links to download transcripts to NotebookLM.',
  ...
  'claude.openNotebook': 'Open a NotebookLM notebook first, then download',
  'claude.cannotGetNlmTab': 'Cannot get NotebookLM tab',
  'claude.openNotebookNotHome': 'Open a NotebookLM notebook (not homepage) first, then download',
  ...
  'claude.step4': 'Download to NotebookLM',
  ...
  'claude.downloadingBtn': 'Downloading...',
  'claude.downloadSelected': 'Download {count} Q&A pairs',
  ...
  'claude.guideStep4': 'Download to NotebookLM — turn AI chats into knowledge sources',
  'claude.shareCard': 'Share Card',
  'claude.guideTip': '💡 Make sure a NotebookLM notebook (not homepage) is open before downloading',

  // ── BookmarkPanel ──
  'bookmark.collection': 'Collection',
  'bookmark.bookmarked': 'Collected',
  'bookmark.addBookmark': 'Collect',
  'bookmark.downloadNow': 'Download',
  'bookmark.all': 'All',
  ...
  'bookmark.downloadToNlm': 'Download to NotebookLM ({count})',
